...
private:
    ...
    std::unique_ptr<QRhiTexture>                container_texture_{};
    std::unique_ptr<QRhiTexture>                container_specular_texture_{};
    ...
    struct lighting_t
    {
        QVector3D position{ 2.4f, 2.0f, 4.0f };
