#ifndef RHI_ANIMATION_H
#define RHI_ANIMATION_H
...
public:
    ...
    Animation(const std::string& path, Model *model)
    {
        ...
        for (int i = 0; i < animation->mNumChannels; ++i) {
            ...
            bones_.push_back({ name, bone_infos[name].id, channel });
        }
...
private:
    void read_heirarchy_data(AssimpNodeData& dest, const aiNode *src)
    {
        ...
        dest.transform =
            QMatrix4x4(src->mTransformation.a1, src->mTransformation.a2, src->mTransformation.a3,
                       src->mTransformation.a4, src->mTransformation.b1, src->mTransformation.b2,
                       src->mTransformation.b3, src->mTransformation.b4, src->mTransformation.c1,
                       src->mTransformation.c2, src->mTransformation.c3, src->mTransformation.c4,
                       src->mTransformation.d1, src->mTransformation.d2, src->mTransformation.d3,
